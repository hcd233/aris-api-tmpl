...
COMPOSE_FILE="${COMPOSE_FILE:-docker/docker-compose-dev-single.yml}"
SERVICE_NAME="${SERVICE_NAME:-aris-api-tmpl-dev}"

printf '\033[1;36mDeploying development environment (branch: %s, image: %s:%s)...\033[0m\n' "${BRANCH_NAME}" "${IMAGE_REPOSITORY}" "${IMAGE_TAG}"
